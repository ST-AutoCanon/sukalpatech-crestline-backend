...
// import * as prVendorService from "../../services/procurement.service/prVendorSelection.service";

// // Add multiple vendors to a PR
// export const addPRVendors = async (req, res) => {
//   const { pr_id, vendor_ids } = req.body;

//   if (!pr_id || !vendor_ids || !vendor_ids.length) {
//     return res
//       .status(400)
//       .json({ success: false, message: "PR ID and vendor IDs required" });
//   }
...
// src/controllers/prVendorSelection.controller.js
import * as prVendorService from "../../services/procurement.service/prVendorSelection.service.js";
