...
// console.log("Login attempt for org_code:", req.body.org_code);
...
//       { id: user.id, email: user.email, role: user.role ,permissions: user.permissions, last_name: user.last_name, org_code: user.org_code},
//       JWT_SECRET,
//       { expiresIn: "1h" }
//     );
