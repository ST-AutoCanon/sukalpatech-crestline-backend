...
router.post("/employee/:id/assign-department", auth, assignEmployeeDeptController); // Assign department to employee (optionally with permission)
router.post(
...
router.post("/employee/:id/unassign-permission", auth, unassignPermissionController); // Unassign permission from a department
