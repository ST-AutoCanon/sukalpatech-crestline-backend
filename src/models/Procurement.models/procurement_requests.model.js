...
// Create a new PR with department ID
// export const createPR = async (data) => {
//   const query = `
//     INSERT INTO procurement_requests
//       (pr_number, project_name, requested_by, requested_by_person, priority, required_delivery_date, remarks, status, requesting_department_id)
...
//     data.remarks,
//     data.status || "draft",
//     data.requesting_department_id || null, // NEW
//   ]);
