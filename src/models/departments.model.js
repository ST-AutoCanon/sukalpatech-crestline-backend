...
// export const unassignEmployeeDepartment = async (employeeId, departmentId, org_code) => {
//   const schema = await getSchemaFromOrgCode(org_code);
//   const result = await thirdDB.query(
...
// export const unassignPermission = async (employeeId, departmentId, org_code) => {
//   const schema = await getSchemaFromOrgCode(org_code);
//   const result = await thirdDB.query(
//     `UPDATE ${schema}.employee_departments
//      SET permission = NULL
